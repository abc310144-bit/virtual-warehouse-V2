...
const MAIN_WAREHOUSE_PRODUCTS = [
  ...
  { key: 'main-03', sku: '3800233070026', productName: '保加利亞 Rice Up! 喜馬拉雅山岩鹽米餅 (120g)', expiryBatch: '2027-01-24_已抽標', allocatableQty: 2, actualQty: 2 },
  ...
  { key: 'main-07', sku: '8801234567890', productName: 'Nature Made 綜合維他命B群 100錠', expiryBatch: '2026-12-31', allocatableQty: 210, actualQty: 210 },
  { key: 'main-08', sku: '4715556667778', productName: 'Swanson 輔酶Q10 100mg 120粒', expiryBatch: '2027-08-20', allocatableQty: 56, actualQty: 80 },
  { key: 'main-09', sku: '4718889990001', productName: 'DHC 綜合維他命 60日份', expiryBatch: '2027-04-05', allocatableQty: 0, actualQty: 15 },
